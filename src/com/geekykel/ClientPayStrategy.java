 ...
 */
public class ClientPayStrategy {
    ...
    public static void main(String[] args) throws IOException {
        while (!order.isClosed()) {
            ...
            System.out.print("Pay NGN" + formatAmount(order.getTotalCost()) + " for " + order.getTotalProduct()  + " units or Continue shopping? P/C: ");
